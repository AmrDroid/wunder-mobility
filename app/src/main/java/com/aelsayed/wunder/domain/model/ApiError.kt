package com.aelsayed.wunder.domain.model
...
data class ApiError(val message: String?, val code: Int?, var errorStatus: ErrorStatus) {
    ...
    /**
     * Various error status based on Api document to know what happened if something goes wrong with a repository call
     */
    enum class ErrorStatus {
        ...
        /**
         * Foursquare’s servers are unhappy. There is either a bug on our side or there is an outage.
